Shader "Holobiont/PetriDishBackgroundLitFlat"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            Name "PetriDishBackgroundLitFlatForward"
            ...
            // URP 3D forward keywords — let the active URP renderer drive shadows, lights, fog.
        ...
        // Shadow caster so the dish can receive its own shadows from additional lights.
        Pass
        {
            Name "ShadowCaster"
